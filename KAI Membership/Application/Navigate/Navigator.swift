...
//            TrackingServices.gameSpin()
    ...
    /* Điều hướng tới màn hình chi tiết dự án của Kai Starter
     - parameter title:
     */
    class func navigateToKaiStarterProjectVC(from viewController: UIViewController? = nil, with title: String) {
